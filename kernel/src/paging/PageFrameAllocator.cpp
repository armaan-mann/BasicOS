...
PageFrameAllocator mainAllocator;
...
void PageFrameAllocator::ReadEFIMemoryMap(EFI_MEMORY_DESCRIPTOR* mMap, size_t mMapSize, size_t mMapDescSize){
    ...
    //reserving all of the memory available on boot and ipon request we will unreserve 
    //pages if needed by the system. Fixes the problem of gaps in memory
    ...
    //reserve pages between 0 and 0x100000, which is to ensure none of bios is touched
